...
### Deploy to Heroku
[![Deploy](https://www.herokucdn.com/deploy/button.svg)](https://heroku.com/deploy?template=https://github.com/kpV2/Auto-Filter-Bot-V2)

### Deploy in your vps
```sh
git clone https://github.com/kpV2/Auto-Filter-Bot-V2
